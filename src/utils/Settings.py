...
SAVE_PATH_POST_OCR = BASE_PATH + "dataframes/POST_OCR_IMPACT"
SAVE_PATH_PRE_OCR_UNCLEANED = BASE_PATH + "dataframes/PRE_OCR_UNCLEANED_IMPACT"
SAVE_PATH_PRE_OCR_CLEANED = BASE_PATH + "dataframes/PRE_OCR_CLEANED_IMPACT"
