# https://gitlab.com/spelfouten/dutch-simpletransformers/-/blob/master/src/dt_classification_RoBERTa_BERT_final_validation.py
...
if __name__ == '__main__':
    ...
    model_args = {
        "num_train_epochs": 1,
        "overwrite_output_dir": 1, # we are moving the dir to a named dir now
    ...
    model = LanguageGenerationModel(
       # "bert", "bert-base-dutch-cased", args=model_args, use_cuda=False,
        ...
        # "roberta", "DTAI-KULeuven/robbert-2022-dutch-base", args=model_args, use_cuda=False,
